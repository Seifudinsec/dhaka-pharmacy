          ...
          <div className="table-wrap">
            <table style={{ width: 'auto', marginBottom: 16, borderCollapse: 'collapse' }}>
              ...
              <tbody>
                ...
                <tr><td style={{ padding: '8px', borderBottom: '1px solid var(--gray-100)' }}><code style={{ background: 'var(--gray-100)', padding: '1px 6px', borderRadius: 4 }}>Selling Price (KES)</code></td><td style={{ padding: '8px', borderBottom: '1px solid var(--gray-100)' }}>Number</td><td style={{ padding: '8px', borderBottom: '1px solid var(--gray-100)' }}>Optional: If blank, it defaults to Buying x 1.4</td></tr>
              </tbody>
            </table>
          </div>
